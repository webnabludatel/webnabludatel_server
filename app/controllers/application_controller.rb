...
class ApplicationController < ActionController::Base
  ...
  def beta_authenticate
    public_controllers = [Admin::WatcherReferralsController, Admin::UserLocationsController, Admin::SosMessagesController, Admin::BaseController, HomeController, SplashSubscribersController, HighVoltage::PagesController, Api::V1::BaseController]
